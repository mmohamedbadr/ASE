<?php
   ...
   * */
  public
          function forgotten_password($identity) {
  if (empty($identity)) {
   ...
   * */
  public
          function register($identity, $password, $email, $additional_data = array(), $groups = array()) {
  ...
  public
          function like($like, $value = NULL, $position = 'both') {
   ...
   * */
  public
          function add_to_group($group_ids, $user_id = false) {
