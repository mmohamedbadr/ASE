<?php
  ...
  protected
          function set_crud_color_picker() {
  $args = func_get_args();
  ...
  public
          function callback_color_picker($value = '', $primary_key = NULL, $field = NULL) {
  $name = $field->name;
  ...
  protected
          function generate_image_crud($table, $url_field, $upload_path, $order_field = 'pos', $title_field = '') {
  // create CRUD object
