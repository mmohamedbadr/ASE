...
// ------------------------------------------------------------------------
  ...
  protected
          function change_list_value($field_info, $value = null) {
  $real_type = $field_info->crud_type;
...
// ------------------------------------------------------------------------
  ...
  protected
          function set_ajax_list_queries($state_info = null) {
  ...
  protected
          function get_relation_array($relation_info, $primary_key_value = null, $limit = null) {
  ...
  protected
          function get_relation_total_rows($relation_info) {
  ...
  protected
          function _get_field_names_to_search(array $relation_values) {
  ...
  protected
          function _unique_join_name($field_name) {
  ...
  protected
          function db_multiple_delete($state_info) {
  ...
  protected
          function db_relation_n_n_update($field_info, $post_data, $primary_key_value) {
  $this->basic_model->db_relation_n_n_update($field_info, $post_data, $primary_key_value);
  }

  protected
          function db_relation_n_n_delete($field_info, $primary_key_value) {
  ...
  protected
          function set_basic_db_table($table_name = null) {
  $this->basic_model->set_basic_table($table_name);
  }

  protected
          function upload_file($state_info) {
  ...
  protected
          function delete_file($state_info) {
  ...
  protected
          function ajax_relation($state_info) {
...
// ------------------------------------------------------------------------
  ...
  protected
          $theme = null;
  protected
          $default_true_false_text = array('inactive', 'active');
  protected
          $css_files = array();
  protected
          $js_files = array();
  ...
  protected
          function showList($ajax = false, $state_info = null) {
  ...
  protected
          function exportToExcel($state_info = null) {
  $data = $this->get_common_data();
  ...
  protected
          function _export_to_excel($data) {
  /**
  ...
  protected
          function print_webpage($state_info = null) {
  $data = $this->get_common_data();
  ...
  protected
          function _trim_print_string($value) {
  $value = str_replace(array("&nbsp;", "&amp;", "&gt;", "&lt;"), array(" ", "&", ">", "<"), $value);
  ...
  protected
          function set_echo_and_die() {
  $this->echo_and_die = true;
  }

  protected
          function unset_echo_and_die() {
  ...
  protected
          function change_list_add_actions($list) {
  ...
  protected
          function change_list($list, $types) {
  $primary_key = $this->get_primary_key();
  ...
  protected
          function showEditForm($state_info) {
  $this->set_js_lib($this->default_javascript_path . '/' . grocery_CRUD::JQUERY);
  ...
  protected
          function showReadForm($state_info) {
  $this->set_js_lib($this->default_javascript_path . '/' . grocery_CRUD::JQUERY);
  ...
  protected
          function delete_layout($delete_result = true) {
  @ob_end_clean();
  if ($delete_result === false) {
  ...
  protected
          function get_success_message_at_list($field_info = null) {
  ...
  protected
          function insert_layout($insert_result = false) {
  @ob_end_clean();
  if ($insert_result === false) {
  ...
  protected
          function validation_layout($validation_result) {
  @ob_end_clean();
  ...
  protected
          function upload_layout($upload_result, $field_name) {
  @ob_end_clean();
  ...
  protected
          function delete_file_layout($upload_result) {
  @ob_end_clean();
  ...
  public
          function get_js_lib_files() {
  return $this->js_lib_files;
  }

  public
          function get_js_config_files() {
  ...
  protected
          function load_js_jqueryui() {
  $this->set_css($this->default_css_path . '/ui/simple/' . grocery_CRUD::JQUERY_UI_CSS);
  $this->set_js_lib($this->default_javascript_path . '/jquery_plugins/ui/' . grocery_CRUD::JQUERY_UI_JS);
  }

  protected
          function load_js_uploader() {
  $this->set_css($this->default_css_path . '/ui/simple/' . grocery_CRUD::JQUERY_UI_CSS);
  ...
  protected
          function update_layout($update_result = false, $state_info = null) {
  @ob_end_clean();
  ...
  protected
          function get_integer_input($field_info, $value) {
  ...
  protected
          function get_true_false_input($field_info, $value) {
  ...
  protected
          function get_string_input($field_info, $value) {
  ...
  protected
          function get_text_input($field_info, $value) {
  ...
  protected
          function get_datetime_input($field_info, $value) {
  $this->set_css($this->default_css_path . '/ui/simple/' . grocery_CRUD::JQUERY_UI_CSS);
  ...
  protected
          function get_hidden_input($field_info, $value) {
  ...
  protected
          function get_password_input($field_info, $value) {
  ...
  protected
          function get_date_input($field_info, $value) {
  $this->set_css($this->default_css_path . '/ui/simple/' . grocery_CRUD::JQUERY_UI_CSS);
  $this->set_js_lib($this->default_javascript_path . '/jquery_plugins/ui/' . grocery_CRUD::JQUERY_UI_JS);
  ...
  protected
          function get_dropdown_input($field_info, $value) {
  $this->load_js_chosen();
  ...
  protected
          function get_enum_input($field_info, $value) {
  $this->load_js_chosen();
  $this->set_js_config($this->default_javascript_path . '/jquery_plugins/config/jquery.chosen.config.js');
  ...
  protected
          function get_readonly_input($field_info, $value) {
  $read_only_value = "&nbsp;";
  ...
  protected
          function get_set_input($field_info, $value) {
  $this->load_js_chosen();
  $this->set_js_config($this->default_javascript_path . '/jquery_plugins/config/jquery.chosen.config.js');
  ...
  protected
          function get_multiselect_input($field_info, $value) {
  $this->load_js_chosen();
  $this->set_js_config($this->default_javascript_path . '/jquery_plugins/config/jquery.chosen.config.js');
  ...
  protected
          function get_relation_input($field_info, $value) {
  $this->load_js_chosen();
  $this->set_js_config($this->default_javascript_path . '/jquery_plugins/config/jquery.chosen.config.js');
  ...
  protected
          function get_relation_readonly_input($field_info, $value) {
  $options_array = $this->get_relation_array($field_info->extras);
  ...
  protected
          function get_upload_file_readonly_input($field_info, $value) {
  ...
  protected
          function get_relation_n_n_input($field_info_type, $selected_values) {
  ...
  protected
          function _convert_bytes_ui_to_bytes($bytes_ui) {
  ...
  protected
          function get_upload_file_input($field_info, $value) {
  ...
  protected
          function get_add_hidden_fields() {
  return $this->add_hidden_fields;
  }

  protected
          function get_edit_hidden_fields() {
  return $this->edit_hidden_fields;
  }

  protected
          function get_add_input_fields($field_values = null) {
  ...
  protected
          function get_edit_input_fields($field_values = null) {
  ...
  protected
          function get_read_input_fields($field_values = null) {
  ...
  protected
          function _theme_view($view, $vars = array(), $return = FALSE) {
  ...
  protected
          function _inline_js($inline_js = '') {
  $this->views_as_string .= "<script type=\"text/javascript\">\n{$inline_js}\n</script>\n";
  }

  protected
          function _add_js_vars($js_vars = array()) {
...
// ------------------------------------------------------------------------
  ...
  protected
          function state_url($url = '', $is_list_page = false) {
  ...
  protected
          function get_state_info_from_url() {
  $ci = &get_instance();
  ...
  protected
          function getAjaxListUrl() {
  return $this->state_url('ajax_list');
  }

  protected
          function getExportToExcelUrl() {
  ...
  protected
          function getValidationInsertUrl() {
  return $this->state_url('insert_validation');
  }

  protected
          function getValidationUpdateUrl($primary_key = null) {
  if ($primary_key === null)
  ...
  protected
          function getReadUrl($primary_key = null) {
  if ($primary_key === null)
  ...
  protected
          function getUpdateUrl($state_info) {
  return $this->state_url('update/' . $state_info->primary_key);
  }

  protected
          function getDeleteUrl($state_info = null) {
  if (empty($state_info)) {
  ...
  protected
          function getDeleteMultipleUrl() {
  return $this->state_url('delete_multiple');
  }

  protected
          function getListSuccessUrl($primary_key = null) {
  ...
  protected
          function getUploadUrl($field_name) {
  return $this->state_url('upload_file/' . $field_name);
  }

  protected
          function getFileDeleteUrl($field_name) {
  return $this->state_url('delete_file/' . $field_name);
  }

  protected
          function getAjaxRelationUrl() {
  return $this->state_url('ajax_relation');
  }

  protected
          function getAjaxRelationManytoManyUrl() {
...
// ------------------------------------------------------------------------
  ...
  const
          JQUERY_UI_JS = "jquery-ui-1.10.3.custom.min.js";
  const
          JQUERY_UI_CSS = "jquery-ui-1.10.1.custom.min.css";
  ...
  protected
          $columns = null;
  private
          $basic_db_table_checked = false;
  private
          $columns_checked = false;
  private
          $add_fields_checked = false;
  private
          $edit_fields_checked = false;
  private
          $read_fields_checked = false;
  protected
  ...
  protected
          $unset_jquery = false;
  protected
          $unset_jquery_ui = false;
  protected
          $unset_bootstrap = false;
  protected
          $unset_list = false;
  protected
          $unset_export = false;
  protected
          $unset_print = false;
  protected
          $unset_back_to_list = false;
  protected
          $unset_columns = null;
  protected
          $unset_add_fields = null;
  protected
          $unset_edit_fields = null;
  protected
          $unset_read_fields = null;

  /* Callbacks */
  protected
          $callback_before_insert = null;
  protected
          $callback_after_insert = null;
  protected
          $callback_insert = null;
  protected
          $callback_before_update = null;
  protected
          $callback_after_update = null;
  protected
          $callback_update = null;
  protected
          $callback_before_delete = null;
  protected
          $callback_after_delete = null;
  protected
          $callback_delete = null;
  protected
          $callback_column = array();
  protected
          $callback_add_field = array();
  protected
          $callback_edit_field = array();
  protected
          $callback_upload = null;
  protected
          $callback_before_upload = null;
  protected
          $callback_after_upload = null;
  protected
          $default_javascript_path = null; //autogenerate, please do not modify
  protected
          $default_css_path = null; //autogenerate, please do not modify
  protected
          $default_texteditor_path = null; //autogenerate, please do not modify
  protected
          $default_theme_path = null; //autogenerate, please do not modify
  protected
          $default_language_path = 'assets/grocery_crud/languages';
  protected
          $default_config_path = 'assets/grocery_crud/config';
  protected
   ...
   */
  public
          function change_field_type($field, $type, $extras = null) {
   ...
   */
  public
          function field_type($field, $type, $extras = null) {
   ...
   */
  public
          function set_primary_key($primary_key_field, $table_name = null) {
   ...
   */
  public
          function set_lang_string($handle, $lang_string) {
  $this->lang_strings[$handle] = $lang_string;
   ...
   */
  public
          function get_lang_string($handle) {
  ...
  protected
          function _set_primary_keys_to_model() {
   ...
   */
  public
          function callback_before_insert($callback = null) {
   ...
   */
  public
          function callback_after_insert($callback = null) {
   ...
   */
  public
          function callback_insert($callback = null) {
   ...
   */
  public
          function callback_before_update($callback = null) {
   ...
   */
  public
          function callback_after_update($callback = null) {
   ...
   */
  public
          function callback_update($callback = null) {
   ...
   */
  public
          function callback_before_delete($callback = null) {
   ...
   */
  public
          function callback_after_delete($callback = null) {
   ...
   */
  public
          function callback_delete($callback = null) {
   ...
   */
  public
          function callback_column($column, $callback = null) {
   ...
   */
  public
          function callback_field($field, $callback = null) {
   ...
   */
  public
          function callback_add_field($field, $callback = null) {
  $this->callback_add_field[$field] = $callback;
   ...
   */
  public
          function callback_edit_field($field, $callback = null) {
  $this->callback_edit_field[$field] = $callback;
   ...
   */
  public
          function callback_upload($callback = null) {
   ...
   */
  public
          function callback_before_upload($callback = null) {
   ...
   */
  public
          function callback_after_upload($callback = null) {
   ...
   */
  public
          function set_crud_url_path($crud_url_path, $list_url_path = null) {
   ...
   */
  public
          function set_subject($subject, $subject_plural = null) {
   ...
   */
  public
          function add_action($label, $image_url = '', $link_url = '', $css_class = '', $url_callback = null) {
   ...
   */
  public
          function set_relation($field_name, $related_table, $related_title_field, $where_clause = null, $order_by = null) {
   ...
   */
  public
          function set_relation_n_n($field_name, $relation_table, $selection_table, $primary_key_alias_to_this_table, $primary_key_alias_to_selection_table, $title_field_selection_table, $priority_field_relation_table = null, $where_clause = null) {
   ...
   */
  public
          function set_field_upload($field_name, $upload_dir = '', $allowed_file_types = '') {
  ...
  private
          function _transliterate_characters($file_name) {
