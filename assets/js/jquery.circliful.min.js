...
!function (a) {
    a.fn.circliful = function (b, c) {
        var d = a.extend({foregroundColor: "#3498DB", backgroundColor: "#ccc", pointColor: "none", fillColor: "none", foregroundBorderWidth: 15, backgroundBorderWidth: 15, pointSize: 28.5, fontColor: "#aaa", percent: 75, animation: 1, animationStep: 5, icon: "none", iconSize: "30", iconColor: "#ccc", iconPosition: "top", target: 0, start: 0, showPercent: 1, percentageTextSize: 22, percentageX: 100, percentageY: 100, textAdditionalCss: "", targetPercent: 0, targetTextSize: 17, targetColor: "#2980B9", text: null, textStyle: null, textColor: "#666", textY: null, textX: null, multiPercentage: 0, percentages: null, textBelow: !1, noPercentageSign: !1, replacePercentageByText: null, halfCircle: !1, animateInView: !1, decimals: 0, alwaysDecimals: !1, title: "Circle Chart", description: ""}, b);
        return this.each(function () {
            ...
            function z() {
                var b = navigator.userAgent.toLowerCase().indexOf("webkit") != -1 ? "body" : "html", c = a(b).scrollTop(), d = c + a(window).height(), e = Math.round(o.offset().top), f = e + o.height();
                return e < d && f > c
            }
            function A() {
            ...
            var b = a(this);
            B(d, b.data());
            var j, k, l, e = d.percent, f = 83, g = 100, h = d.percentageY, i = d.percentageX, m = d.backgroundBorderWidth;
            if (d.halfCircle ? "left" == d.iconPosition ? (g = 80, f = 100, i = 117, h = 100) : d.halfCircle && (f = 80, h = 100) : "bottom" == d.iconPosition ? (f = 124, h = 95) : "left" == d.iconPosition ? (g = 80, f = 110, i = 117) : "middle" == d.iconPosition ? 1 == d.multiPercentage ? "object" == typeof d.percentages ? m = 30 : (f = 110, k = '<g stroke="' + ("none" != d.backgroundColor ? d.backgroundColor : "#ccc") + '" ><line x1="133" y1="50" x2="140" y2="40" stroke-width="2"  /></g>', k += '<g stroke="' + ("none" != d.backgroundColor ? d.backgroundColor : "#ccc") + '" ><line x1="140" y1="40" x2="200" y2="40" stroke-width="2"  /></g>', i = 228, h = 47) : (f = 110, k = '<g stroke="' + ("none" != d.backgroundColor ? d.backgroundColor : "#ccc") + '" ><line x1="133" y1="50" x2="140" y2="40" stroke-width="2"  /></g>', k += '<g stroke="' + ("none" != d.backgroundColor ? d.backgroundColor : "#ccc") + '" ><line x1="140" y1="40" x2="200" y2="40" stroke-width="2"  /></g>', i = 170, h = 35) : "right" == d.iconPosition && (g = 120, f = 110, i = 80), d.targetPercent > 0 && (h = 95, k = '<g stroke="' + ("none" != d.backgroundColor ? d.backgroundColor : "#ccc") + '" ><line x1="75" y1="101" x2="125" y2="101" stroke-width="1"  /></g>', k += '<text text-anchor="middle" x="' + i + '" y="120" style="font-size: ' + d.targetTextSize + 'px;" fill="' + d.targetColor + '">' + d.targetPercent + (d.noPercentageSign && null == d.replacePercentageByText ? "" : "%") + "</text>", k += '<circle cx="100" cy="100" r="69" fill="none" stroke="' + d.backgroundColor + '" stroke-width="3" stroke-dasharray="450" transform="rotate(-90,100,100)" />', k += '<circle cx="100" cy="100" r="69" fill="none" stroke="' + d.targetColor + '" stroke-width="3" stroke-dasharray="' + 3.6 * d.targetPercent + ', 20000" transform="rotate(-90,100,100)" />'), null != d.text && (d.halfCircle ? d.textBelow ? k += '<text text-anchor="middle" x="' + (null != d.textX ? d.textX : "100") + '" y="' + (null != d.textY ? d.textY : "120") + '" style="' + d.textStyle + '" fill="' + d.textColor + '">' + d.text + "</text>" : 0 == d.multiPercentage ? k += '<text text-anchor="middle" x="' + (null != d.textX ? d.textX : "100") + '" y="' + (null != d.textY ? d.textY : "115") + '" style="' + d.textStyle + '" fill="' + d.textColor + '">' + d.text + "</text>" : 1 == d.multiPercentage && (k += '<text text-anchor="middle" x="' + (null != d.textX ? d.textX : "228") + '" y="' + (null != d.textY ? d.textY : "65") + '" style="' + d.textStyle + '" fill="' + d.textColor + '">' + d.text + "</text>") : d.textBelow ? k += '<text text-anchor="middle" x="' + (null != d.textX ? d.textX : "100") + '" y="' + (null != d.textY ? d.textY : "190") + '" style="' + d.textStyle + '" fill="' + d.textColor + '">' + d.text + "</text>" : 0 == d.multiPercentage ? k += '<text text-anchor="middle" x="' + (null != d.textX ? d.textX : "100") + '" y="' + (null != d.textY ? d.textY : "115") + '" style="' + d.textStyle + '" fill="' + d.textColor + '">' + d.text + "</text>" : 1 == d.multiPercentage && (k += '<text text-anchor="middle" x="' + (null != d.textX ? d.textX : "228") + '" y="' + (null != d.textY ? d.textY : "65") + '" style="' + d.textStyle + '" fill="' + d.textColor + '">' + d.text + "</text>")), "none" != d.icon && (l = '<text text-anchor="middle" x="' + g + '" y="' + f + '" class="icon" style="font-size: ' + d.iconSize + 'px" fill="' + d.iconColor + '">&#x' + d.icon + "</text>"), d.halfCircle) {
